...
### Woo, B., Liu, S., & Spelke, E. S. (unpublished). Three-month-olds' understanding of object identity vs location as the goals of other people's reaches.
...
strip.cols <- function(x) {
  ...
  # stripped.cols$paper <- as.character(x)
...
fulldata <- read.csv("newfile.csv",header=FALSE)
colnames(fulldata) <- c("subjID", "condition", "ageday", "exp_look", "unexp_look", "sex")
