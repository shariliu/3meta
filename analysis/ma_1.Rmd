...
plot1 <- ggplot(ind.data.long,
  ...
  ylab("Looking Time (s)")+
  xlab("Condition")+
  facet_wrap(~task+paper+condition, nrow=2, labeller=label_wrap_gen())+
