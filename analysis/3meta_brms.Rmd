...
stancode(constraints.brms.intercept)
standata(constraints.brms.intercept)
...
constraints.brms.full.simplerfx <- update(constraints.brms.full, 
                                formula. = ~. + (1 | experiment) + (1 | paper))
getCall(constraints.brms.full)
