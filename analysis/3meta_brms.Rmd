...
goals.brms.intercept.results <- brms.test.hyp(goals.brms.intercept, "Intercept > 0")
...
constraints.brms.intercept.results <- brms.test.hyp(constraints.brms.intercept, "Intercept > 0")
